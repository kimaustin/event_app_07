defmodule EventApp07Web.EventControllerTest do
  use EventApp07Web.ConnCase

  alias EventApp07.Events

  @create_attrs %{date: "some date", desc: "some desc", title: "some title"}
  @update_attrs %{date: "some updated date", desc: "some updated desc", title: "some updated title"}
